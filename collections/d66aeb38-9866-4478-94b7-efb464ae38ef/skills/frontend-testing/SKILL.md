...
description: >-
  Generate Vitest + React Testing Library tests for Dify frontend components, hooks, and utilities. Triggers on testing,
  spec files, coverage, Vitest, RTL, unit tests, integration tests, or write/review test requests.
metadata:
  references: >-
    references/async-testing.md,references/checklist.md,references/common-patterns.md,references/domain-components.md,references/mocking.md,references/workflow.md
---
