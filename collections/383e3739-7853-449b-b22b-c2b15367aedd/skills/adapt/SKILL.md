...
metadata:
  ...
  args_target.name: target
  args_target.description: The feature or component to adapt (optional)
  args_target.required: false
  args_context.name: context
  args_context.description: What to adapt for (mobile, tablet, desktop, print, email, etc.)
  args_context.required: false
  user-invokable: true
---
